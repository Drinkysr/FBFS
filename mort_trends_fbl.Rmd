...
## Stomach Cancer Incidence Trends (SEER)
```{r, fig.width=10, fig.height = 6, fig.algn='center'}
# Load the data
...
## Stomach Cancer Death Rate Trends (CDC)
```{r, fig.width=10, fig.height = 6, fig.algn='center'}
...
```
## Colon Cancer Incidence Trends (SEER)
```{r, fig.width=10, fig.height = 6, fig.algn='center'}
col1 <- ca %>% 
...
## Colon Cancer Death Rate Trends (CDC)
```{r, fig.width=10, fig.height = 6.5, fig.algn='center'}
